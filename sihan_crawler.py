...
def main(args):
    ...
    print("Sihan's Post Crawling Start ! ")
    mode="headless"
    if mode == "headless":
    ...
    root = "https://sihan-son.github.io"
    main_page = f"https://sihan-son.github.io/{category}/"
    ...
    try:
        csv_file_read = open('crawler_checker_sihan.csv', mode='r')
    ...
    csv_file_write = open('crawler_checker_sihan.csv', mode='a')
    ...
    for page_num in range(int(last_page), 0, -1):
        if page_num != 1:
